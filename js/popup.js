...
!(function (e, t) {
    ...
    const he = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
        ...
        Ae = {};
    (Ae.text = Ae.email = Ae.password = Ae.number = Ae.tel = Ae.url = Ae.search = Ae.date = Ae["datetime-local"] = Ae.time = Ae.week = Ae.month = (e, t) => (Ce(e, t.inputValue), we(e, e, t), ye(e, t), (e.type = t.input), e)),
            ...
            return (
                Array.from(e.querySelectorAll("swal-button")).forEach((e) => {
                    ...
                    n &&
                        ...
                        ((t[`${n}ButtonText`] = e.innerHTML), (t[`show${c(n)}Button`] = !0), e.hasAttribute("color") && (t[`${n}ButtonColor`] = e.getAttribute("color")), e.hasAttribute("aria-label") && (t[`${n}ButtonAriaLabel`] = e.getAttribute("aria-label")));
                }),
                t
            );
        },
